...
export const noWrap = (props: TextProps): any =>
  props.noWrap ? { whiteSpace: 'nowrap' } : null

export const align = (props: TextProps): any =>
  props.align ? mq({ textAlign: props.align }) : null

export const bold = (props: TextProps): any =>
...
export const bolder = (props: TextProps): any =>
...
const fullWidth = (props: TextProps) =>
...
const Text = styled.p<TextProps>`
  ...
  ${(props) => {
    if (typeof props.ff !== 'undefined') {
      if (
        typeof props.ff === 'number' &&
        typeof props.theme.fontFamilies[props.ff] !== 'undefined'
      ) {
